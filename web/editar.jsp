        ...
        <form action="/editarLibro" method="post">
            <div class="modal-content">
                ...
                <div class="input-field col s12">
                    ...
                    <input id="tituloedit" name="tituloedit" type="text" class="validate" required value="${libro.titulo}">
                    <label for="tituloedit">Titulo</label>
                </div>
                <div class="input-field col s12">
                    <i class="mdi-action-account-circle prefix"></i>
                    <input id="autoredit" name="autoredit" type="text" class="validate" required value="${libro.autor}">
                    <label for="autoredit">Autor</label>
                </div>
                <div class="input-field col s12">
                    <i class="mdi-social-school prefix"></i>
                    <input id="carreraedit" name="carreraedit" type="text" class="validate" required value="${libro.carrera}">
                    <label for="carreraedit">Carrera</label>
                </div>
                <div class="input-field col s12">
                    <i class="mdi-social-domain prefix"></i>
                    <input id="edicionedit" name="edicionedit" type="text" class="validate" required value="${libro.edicion}">
                    <label for="edicionedit">Edicion</label>
                </div>
                <div class="input-field col s12">
                    <i class="mdi-social-plus-one prefix"></i>
                    <input id="cantidadedit" name="cantidadedit" type="number" class="validate" required value="${libro.cantidad}">
                ...
                <textarea id="descripcionedit" name="descripcionedit" class="materialize-textarea validate"
